...
/**
 * Generated descriptor for StageService DBPlayerDataJSONDef.
 */
public final class DBPlayerDataJSONDefDescriptor {
    public static final DbEntityDescriptor INSTANCE = DbEntityDescriptor.builder(
                    "StageService",
                    "DBPlayerDataJSONDef",
                    "org.evd.game.StageService.dbEntity.DBPlayerDataJSONDef",
                    "DBPlayerDataJSONDef",
                    DBserialize.JSON,
                    false)
            ...
            .addField(7, "intDBItemMap", "java.util.Map<java.lang.Integer, org.evd.game.StageService.dbEntity.DBItemDataJSONDef>", false, "", "DBItemDataJSONDef")
    ...
    private DBPlayerDataJSONDefDescriptor() {
    }
}
