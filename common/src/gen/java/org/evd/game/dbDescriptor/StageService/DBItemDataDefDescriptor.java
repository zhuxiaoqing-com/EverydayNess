...
/**
 * Generated descriptor for StageService DBItemDataDef.
 */
public final class DBItemDataDefDescriptor {
    public static final DbEntityDescriptor INSTANCE = DbEntityDescriptor.builder(
                    "StageService",
                    "DBItemDataDef",
                    "org.evd.game.StageService.dbEntity.DBItemDataDef",
                    "DBItemDataDef",
                    DBserialize.PB,
                    false)
    ...
    private DBItemDataDefDescriptor() {
    }
}
