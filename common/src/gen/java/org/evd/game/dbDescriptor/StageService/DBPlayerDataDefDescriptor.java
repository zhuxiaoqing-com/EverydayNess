...
/**
 * Generated descriptor for StageService DBPlayerDataDef.
 */
public final class DBPlayerDataDefDescriptor {
    public static final DbEntityDescriptor INSTANCE = DbEntityDescriptor.builder(
                    "StageService",
                    "DBPlayerDataDef",
                    "org.evd.game.StageService.dbEntity.DBPlayerDataDef",
                    "DBPlayerDataDef",
                    DBserialize.PB,
                    true)
            .addField(1, "id", "long", true, "", null)
            ...
            .addField(7, "intDBItemMap", "java.util.Map<java.lang.Integer, org.evd.game.StageService.dbEntity.DBItemDataDef>", false, "", "DBItemDataDef")
    ...
    private DBPlayerDataDefDescriptor() {
    }
}
