...
public final class DbValueIOSerializer{
	/**
	 * 序列化
	 * @param out 输出流
	 * @param instance 实例
	 */
	public static void write(OutputStream out, DbValue instance) throws IOException {
	 ...
	 * @param instance 实例
	 */
	public static void read(InputStream in, DbValue instance) throws IOException {
