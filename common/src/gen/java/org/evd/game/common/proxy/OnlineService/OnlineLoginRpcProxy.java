...
/**
* 根据OnlineLoginRpcService生成的代理类
*/
public final class OnlineLoginRpcProxy {

    private static final OnlineLoginRpcProxy INSTANCE = new OnlineLoginRpcProxy();

    private OnlineLoginRpcProxy() {
    }

    public static OnlineLoginRpcProxy inst() {
        return INSTANCE;
    }
    ...
    */
    ...
    /**
    * 对应源方法: org.evd.game.OnlineService.login.OnlineLoginRpc#cancelPendingSession()
    */
    ...
    /**
    * 对应源方法: org.evd.game.OnlineService.login.OnlineLoginRpc#cancelQueuedLogin()
    */
