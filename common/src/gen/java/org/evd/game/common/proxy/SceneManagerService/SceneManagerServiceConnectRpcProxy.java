...
public final class SceneManagerServiceConnectRpcProxy {
    ...
    */
    public static RpcResult<Void> sendRestoreStageMaps(CallPoint remote, CallServiceInitDataSync syncData, CallPoint stage, List<SMapInfo> maps){
        return RpcResult.run(() -> inst().restoreStageMaps(remote, syncData, stage, maps));
    }
