...
public final class LobbyServiceRpcProxy {
    ...
    */
    public static RpcResult<SLobbyRoleSnapshot> callGetRole(CallPoint remote, String userId){
    ...
    * 对应源方法的结果版本；远端错误、断链和超时均通过 RpcResult 返回。
    */
    public static RpcResult<SLobbyUserAccessResult> callValidateOrCreateUser(CallPoint remote, String userId){
