...
public final class DBServiceProxy {
    ...
    */
    public static DBRsp dbExec(CallPoint remote, DBReq dbReq){
        ...
        return (DBRsp)service.callWait(remote, EnumCall.ENUM_DBSERVICE_ORG_EVD_GAME_DB_SERIALIZE_DBRSP_DBEXEC_ORG_EVD_GAME_DB_SERIALIZE_DBREQ, new Object[]{dbReq});
    }
    public static DBRsp dbExec(CallPoint remote, DBReq dbReq, long timeoutMillis){
        Service service = Service.getCurrent();
        return (DBRsp)service.callWait(remote, EnumCall.ENUM_DBSERVICE_ORG_EVD_GAME_DB_SERIALIZE_DBRSP_DBEXEC_ORG_EVD_GAME_DB_SERIALIZE_DBREQ, new Object[]{dbReq}, timeoutMillis);
    }
}
