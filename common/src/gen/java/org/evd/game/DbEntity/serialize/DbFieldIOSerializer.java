...
public final class DbFieldIOSerializer{
	...
	public static void write(OutputStream out, DbField instance) throws IOException {
		...
		org.evd.game.DbEntity.serialize.DbValueIOSerializer.write(out, instance.getValue());
	}
	...
	public static void read(InputStream in, DbField instance) throws IOException {
		...
		org.evd.game.DbEntity.serialize.DbValue value = new org.evd.game.DbEntity.serialize.DbValue();
		org.evd.game.DbEntity.serialize.DbValueIOSerializer.read(in, value);
