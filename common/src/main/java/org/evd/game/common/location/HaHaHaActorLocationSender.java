...
public class HaHaHaActorLocationSender {
    ...
    public void rpc1(long actorId, int a, int b) {
        actorLocationSender.send(actorId, HaHaHaActorProxy.EnumCall.ENUM_HAHAHAACTOR_VOID_RPC1_INT_INT, new Object[]{a, b});
    }

    public void rpc2(long actorId, Object a, Object b) {
        actorLocationSender.send(actorId, HaHaHaActorProxy.EnumCall.ENUM_HAHAHAACTOR_VOID_RPC2_OBJECT_OBJECT, new Object[]{a, b});
    }
}
