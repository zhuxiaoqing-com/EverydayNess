package org.evd.game.common.serializeBean.OnlineService;
...
public class OnlineUserState implements ISerializable {
    ...
    public ActorAddress getActivePlayerActorAddress() {
        return activePlayerActorAddress == null ? null : new ActorAddress(activePlayerActorAddress);
    }

    public void setActivePlayerActorAddress(ActorAddress activePlayerActorAddress) {
        this.activePlayerActorAddress = activePlayerActorAddress == null
                ? null : new ActorAddress(activePlayerActorAddress);
    }

    public ActorAddress getActiveGateActorAddress() {
        return activeGateActorAddress == null ? null : new ActorAddress(activeGateActorAddress);
    }

    public void setActiveGateActorAddress(ActorAddress activeGateActorAddress) {
        this.activeGateActorAddress = activeGateActorAddress == null
                ? null : new ActorAddress(activeGateActorAddress);
    }
