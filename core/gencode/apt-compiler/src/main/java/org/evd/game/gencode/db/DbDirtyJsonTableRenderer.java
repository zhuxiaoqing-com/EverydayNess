...
final class DbDirtyJsonTableRenderer {
    String render(DbDirtyEntityMeta entity) {
        ...
        sb.append("                v MEDIUMTEXT NOT NULL\n");
        ...
        sb.append("        valueList.add(new DbValue(encodeJsonPayload(value)));\n");
        ...
        sb.append("    }\n\n");
        sb.append("    private ").append(entity.beanClassName).append(" decodeJsonPayload(String payload) {\n");
        sb.append("        if (payload == null || payload.isEmpty()) {\n");
        sb.append("            return new ").append(entity.beanClassName).append("();\n");
        sb.append("        }\n");
        sb.append("        ").append(entity.beanClassName).append(" value = JSON.parseObject(payload, ").append(entity.beanClassName).append(".class);\n");
        sb.append("        if (value == null) {\n");
        sb.append("            return new ").append(entity.beanClassName).append("();\n");
        sb.append("        }\n");
        sb.append("        return value;\n");
