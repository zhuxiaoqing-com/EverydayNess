...
public final class ActorMessageIOSerializer{
	/**
	 * 序列化
	 * @param out 输出流
	 * @param instance 实例
	 */
	public static void write(OutputStream out, ActorMessage instance) throws IOException {
	 ...
	 * @param instance 实例
	 */
	public static void read(InputStream in, ActorMessage instance) throws IOException {
