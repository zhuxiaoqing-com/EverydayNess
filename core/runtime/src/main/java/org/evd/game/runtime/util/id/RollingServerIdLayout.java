 ...
 * </pre>
 */
public final class RollingServerIdLayout implements SnowflakeIdLayout {
    ...
    static {
        SnowflakeIdLayout.requireTotalBits("RollingServerIdLayout",
    ...
    public RollingServerIdLayout(int platformId, int playerServerId) {
        this(platformId, playerServerId, 0);
    }

    public RollingServerIdLayout(int platformId, int playerServerId, int nodeId) {
