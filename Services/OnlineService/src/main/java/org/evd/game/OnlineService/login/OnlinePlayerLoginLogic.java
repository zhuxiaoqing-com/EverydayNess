...
/** OnlineService 的选角登录业务逻辑，OnlinePlayer 是本流程的生命周期状态。 */
@Actor
public final class OnlinePlayerLoginLogic {
    public void selectRoleEnter(ClientSessionRef session, C2S_SelectRoleEnter request) {
        ...
        RoleData roleData = RoleData.newBuilder()
                ...
                .build();
        RpcResult<ActorAddress> playerLogin = PlayerLoginRpcProxy.callLoginPlayer(
        ...
        RpcResult<ActorAddress> gateBound = ConnLoginRpcProxy.callBindPlayer(
