...
public final class OnlineSessionCoordinator {
    ...
    public OnlinePlayer beginOnlinePlayer(String userId, CallPoint gate, long gateSessionId,
        ...
        if (onlinePlayer != null) {
            // 保留 SOnlineUserState 的兼容镜像；实际玩家生命周期以 OnlinePlayer 为准。
    ...
    /** 将 PlayerService 返回的玩家 ActorAddress 登记到 SOnlineUserState。 */
    ...
    /** 将 GW 返回的玩家 ActorAddress 登记到 SOnlineUserState。 */
