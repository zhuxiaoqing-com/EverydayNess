...
public final class AdminHttpServer {
    ...
    public AdminHttpServer(Service service, int port) {
        ...
        AdminHttpRouteRegistry routeRegistry = AdminHttpRouteRegistry.load("org.evd.game.AdminService.controller");
        bootstrap.group(bossGroup, workerGroup)
                .channel(epollAvailable ? EpollServerSocketChannel.class : NioServerSocketChannel.class)
                .childHandler(new AdminHttpServerInitializer(routeRegistry, service));
        try {
