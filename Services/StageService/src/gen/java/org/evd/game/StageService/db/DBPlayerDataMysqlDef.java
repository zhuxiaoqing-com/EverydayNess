...
public final class DBPlayerDataMysqlDef extends DirtyObject {
    private String id;
    private String name;
    private int lv;
    ...
    private XHashMap<Integer, DBItemDataMysqlDef> intDBItemMap;

    DBPlayerDataMysqlDef(DirtyObject _xp_) {
        super(_xp_);
        this.id = "";
        this.name = "";
    ...
    public DBPlayerDataMysqlDef() {
        this((DirtyObject)null);
    }

    public DBPlayerDataMysqlDef(DBPlayerDataMysqlDef _o_) {
        this(_o_, null);
    }

    DBPlayerDataMysqlDef(DBPlayerDataMysqlDef _o_, DirtyObject _xp_) {
        super(_xp_);
        this.id = _o_.id;
        this.name = _o_.name;
        this.lv = _o_.lv;
        ...
        this.intDBItemMap = new XHashMap<>(this);
        _o_.intDBItemMap.forEach((_k_, _v_) -> this.intDBItemMap.put(_k_, _v_ == null ? null : new DBItemDataMysqlDef(_v_, this.intDBItemMap)));
        this.dirty = false;
    }

    public void copyFrom(DBPlayerDataMysqlDef _o_) {
        this.id = _o_.id;
        this.name = _o_.name;
        this.lv = _o_.lv;
        this.intIntMap = new XHashMap<>(this);
    ...
    public java.util.Map<Integer, DBItemDataMysqlDef> getIntDBItemMap(){
        return this.intDBItemMap;
    }

    public void setIntDBItemMap(XHashMap<Integer, DBItemDataMysqlDef> _v_){
