...
public final class DBPlayerDataJSONDef extends DirtyObject {
    @JSONField(name = "1")
    private String id;
    @JSONField(name = "2")
    private String name;
    ...
    @JSONField(name = "7")
    private XHashMap<Integer, DBItemDataJSONDef> intDBItemMap;

    DBPlayerDataJSONDef(DirtyObject _xp_) {
        super(_xp_);
        this.id = "";
        this.name = "";
    ...
    public DBPlayerDataJSONDef() {
        this((DirtyObject)null);
    }

    public DBPlayerDataJSONDef(DBPlayerDataJSONDef _o_) {
        this(_o_, null);
    }

    DBPlayerDataJSONDef(DBPlayerDataJSONDef _o_, DirtyObject _xp_) {
        super(_xp_);
        this.id = _o_.id;
        this.name = _o_.name;
        this.lv = _o_.lv;
        ...
        this.intDBItemMap = new XHashMap<>(this);
        _o_.intDBItemMap.forEach((_k_, _v_) -> this.intDBItemMap.put(_k_, _v_ == null ? null : new DBItemDataJSONDef(_v_, this.intDBItemMap)));
        this.dirty = false;
    }

    public void copyFrom(DBPlayerDataJSONDef _o_) {
        this.id = _o_.id;
        this.name = _o_.name;
        this.lv = _o_.lv;
        this.intIntMap = new XHashMap<>(this);
    ...
    public java.util.Map<Integer, DBItemDataJSONDef> getIntDBItemMap(){
        return this.intDBItemMap;
    }

    public void setIntDBItemMap(XHashMap<Integer, DBItemDataJSONDef> _v_){
