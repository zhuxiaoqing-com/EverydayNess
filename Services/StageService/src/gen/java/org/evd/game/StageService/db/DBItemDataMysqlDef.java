...
public final class DBItemDataMysqlDef extends DirtyObject {
    private long itemSrl;
    private int itemId;
    private String itemName;

    DBItemDataMysqlDef(DirtyObject _xp_) {
        super(_xp_);
        this.itemName = "";
    }

    public DBItemDataMysqlDef() {
        this((DirtyObject)null);
    }

    public DBItemDataMysqlDef(DBItemDataMysqlDef _o_) {
        this(_o_, null);
    }

    DBItemDataMysqlDef(DBItemDataMysqlDef _o_, DirtyObject _xp_) {
        super(_xp_);
    ...
    public void copyFrom(DBItemDataMysqlDef _o_) {
        this.itemSrl = _o_.itemSrl;
        this.itemId = _o_.itemId;
        this.itemName = _o_.itemName;
        makeModify();
