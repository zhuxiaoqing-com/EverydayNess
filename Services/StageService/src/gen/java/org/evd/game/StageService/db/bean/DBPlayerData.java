...
public final class DBPlayerData extends DirtyObject implements ISerializable {
    @Tag(1)
    private long id;
    @Tag(2)
    private String name;
    ...
    @Tag(7)
    private XHashMap<Integer, DBItemData> intDBItemMap;
    @Tag(8)
    private DBItemData obj1;
    @Tag(9)
    private byte[] bytes;

    DBPlayerData(DirtyObject _xp_) {
        super(_xp_);
        this.id = 0L;
        this.name = "";
        this.lv = 0;
    ...
    public DBPlayerData(DBPlayerData _o_) {
        this(_o_, null);
    }

    DBPlayerData(DBPlayerData _o_, DirtyObject _xp_) {
        super(_xp_);
        this.id = _o_.id;
        this.name = _o_.name;
        this.lv = _o_.lv;
        ...
        this.intDBItemMap = new XHashMap<>(this);
        _o_.intDBItemMap.forEach((_k_, _v_) -> this.intDBItemMap.put(_k_, _v_ == null ? null : new DBItemData(_v_, this.intDBItemMap)));
        this.obj1 = _o_.obj1 == null ? null : new DBItemData(_o_.obj1, this);
        this.bytes = _o_.bytes;
        this.dirty = false;
    }

    public void copyFrom(DBPlayerData _o_) {
        this.id = _o_.id;
        this.name = _o_.name;
        this.lv = _o_.lv;
        this.intIntMap = new XHashMap<>(this);
    ...
    public java.util.Map<Integer, DBItemData> getIntDBItemMap(){
        return this.intDBItemMap;
    }

    public void setIntDBItemMap(XHashMap<Integer, DBItemData> _v_){
    ...
    public DBItemData getObj1(){
        return this.obj1;
    }

    public void setObj1(DBItemData _v_){
        this.obj1 = _v_;
        if (_v_ != null) {
            _v_.setParent(this);
        }
    ...
    public void writeTo(OutputStreamBase out) throws IOException {
        ...
        if (this.intDBItemMap == null) {
            ...
            for (java.util.Map.Entry<Integer, DBItemData> _entry_3 : this.intDBItemMap.entrySet()) {
    ...
    public void readFrom(InputStreamBase in) throws IOException {
        ...
        DBItemData _v_17 = null;
        if (in.readBoolean()) {
            _v_17 = new DBItemData();
            _v_17.beforeRead(in);
            _v_17.readFrom(in);
            _v_17.afterRead(in);
