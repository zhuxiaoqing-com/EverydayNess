...
public final class DBPlayerDataJSON extends DirtyObject implements ISerializable {
    ...
    DBPlayerDataJSON(DBPlayerDataJSON _o_, DirtyObject _xp_) {
        ...
        this.obj1 = _o_.obj1 == null ? null : new DBItemDataJSON(_o_.obj1, this);
    ...
    public DBItemDataJSON getObj1(){
        return this.obj1;
    }

    public void setObj1(DBItemDataJSON _v_){
        this.obj1 = _v_;
        if (_v_ != null) {
            _v_.setParent(this);
        }
    ...
    public void writeTo(OutputStreamBase out) throws IOException {
        ...
        if (this.intDBItemMap == null) {
            ...
            for (java.util.Map.Entry<Integer, DBItemDataJSON> _entry_3 : this.intDBItemMap.entrySet()) {
    ...
    public void readFrom(InputStreamBase in) throws IOException {
        ...
        DBItemDataJSON _v_17 = null;
        if (in.readBoolean()) {
            _v_17 = new DBItemDataJSON();
            _v_17.beforeRead(in);
            _v_17.readFrom(in);
            _v_17.afterRead(in);
