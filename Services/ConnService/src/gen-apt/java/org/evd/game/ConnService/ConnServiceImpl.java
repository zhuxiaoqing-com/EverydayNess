...
public class ConnServiceImpl extends RPCImplBase {
    ...
    public Object getMethodFunction(Service serv, int methodKey) {
        ...
        switch (methodKey){
            ...
            case EnumCall.ENUM_CONNSERVICE_VOID_PUSHTOCLIENT_ORG_EVD_GAME_RUNTIME_CLIENT_CLIENTSESSIONREF_INT_ORG_EVD_GAME_RUNTIME_CHUNK:
                return (Function3<org.evd.game.runtime.client.ClientSessionRef, Integer, org.evd.game.runtime.Chunk>)service::pushToClient;
